...
export const learningResources: LearningResource[] = [
  ...
  {
    id: 'coursera-ai-roadmap',
    name: 'Coursera AI Learning Roadmap',
    url: 'https://www.coursera.org/resources/ai-learning-roadmap',
    blurb: 'Step-by-step path from math foundations through ML, NLP, and career skills.',
    category: 'learning',
    topicHints: ['llms-prompting', 'ai-agents'],
  },
  {
    id: 'deeplearning-ai',
    name: 'DeepLearning.AI',
    url: 'https://www.deeplearning.ai/',
    blurb: 'Andrew Ng short courses + The Batch — practical GenAI without the fluff.',
    category: 'learning',
    topicHints: ['llms-prompting', 'ai-agents', 'rag-context'],
  },
  {
    id: 'prompting-guide',
    name: 'Prompt Engineering Guide',
    url: 'https://www.promptingguide.ai/',
    blurb: 'Techniques, templates, and RAG/agent patterns — the foundation skill for LLM work.',
    category: 'tech',
    topicHints: ['llms-prompting', 'ai-agents', 'rag-context'],
  },
  {
    ...
    blurb: 'Production recipes for RAG, agents, structured outputs, and evals.',
    category: 'tech',
    topicHints: ['llms-prompting', 'ai-agents', 'rag-context'],
  },
  {
    ...
    blurb: 'Copy-paste notebooks for Claude — tools, vision, agents, and long context.',
    category: 'tech',
    topicHints: ['llms-prompting', 'ai-agents'],
  },
  {
    ...
    blurb: 'Free transformers, NLP, and open-model training course from the HF team.',
    category: 'learning',
    topicHints: ['llms-prompting', 'rag-context'],
  },
  {
    ...
    blurb: 'Top-down deep learning courses — code first, theory when you need it.',
    category: 'learning',
    topicHints: ['llms-prompting', 'ai-agents'],
  },
  {
    ...
    blurb: 'Human-centered AI research, policy, and explainers from Stanford.',
    category: 'tech',
    topicHints: ['ai-agents', 'current-events'],
  },
  {
    ...
    blurb: 'Free beginner course on what AI can and cannot do — no coding required.',
    category: 'learning',
    topicHints: ['llms-prompting', 'mental-models'],
  },
  {
    id: 'google-ml-crash-course',
    name: 'Google ML Crash Course',
    url: 'https://developers.google.com/machine-learning/crash-course',
    blurb: 'Fast TensorFlow-oriented intro with interactive exercises.',
    category: 'learning',
    topicHints: ['llms-prompting'],
  },
  {
    id: 'ai-weekly-site',
    name: 'AI Weekly',
    url: 'https://aiweekly.co/',
    blurb: 'Curated AI briefing 3x/week since 2015 — research, business, and safety.',
    category: 'news',
    topicHints: ['ai-agents', 'current-events'],
  },
  {
